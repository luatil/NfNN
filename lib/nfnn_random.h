...
static void
NfNN_Random_Init(nfnn_random_state* RandomState, u32 Seed)
{
    NFNN_ASSERT(RandomState != 0, "RandomState is null");
    RandomState->State = Seed;
}

static nfnn_random_state
NfNN_Random_Seed(u32 Seed)
{
...
static u32 
NfNN_Random_Next(nfnn_random_state* RandomState)
{
    NFNN_ASSERT(RandomState != 0, "RandomState is null");
...
static f32 
NfNN_Random_ZeroToOne(nfnn_random_state* RandomState)
{
...
static f32
NfNN_Random_Range_f32(nfnn_random_state* RandomState, f32 Min, f32 Max)
{
...
static u32
NfNN_Random_Range_u32(nfnn_random_state* RandomState, u32 Min, u32 Max)
{
...
static void
NfNN_Random_ShuffleInPlace_u32(nfnn_random_state* RandomState, u32 *Array, u32 N)
{
    for(u32 I = 0; I < N; I++)
    {
...
static void
NfNN_Random_UniformArrayInRange_f32(nfnn_random_state* RandomState, f32 *Array, u32 N, f32 Min, f32 Max)
{
    for(u32 I = 0; I < N; I++)
    {
...
static void
NfNN_Random_UniformArrayInRange_u32(nfnn_random_state* RandomState, u32 *Array, u32 N, u32 Min, u32 Max)
{
    for(u32 I = 0; I < N; I++)
    {
